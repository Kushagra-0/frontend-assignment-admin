...
import { pendingPaymentRequests } from "../../../../../constants/payments/PendingPaymentRequests";
              ...
              <tbody>
                {pendingPaymentRequests.map((request) => (
                  <tr key={request.id} className="border-b border-gray-300">
                    ...
                    <td className="px-4 text-sm text-green-600 font-medium">Accept  <span className="text-red-600 ml-4">Decline</span></td>
                  </tr>
                ))}
              </tbody>
            </table>
