...
import { affiliateCommissionSpecialCommission } from "../../../../constants/AffiliateCommissionSpecialCommission";
    ...
    <div className="min-h-screen pb-12">
      ...
      <div className="mb-6">
        <div className='flex flex-row justify-between mb-4'>
          <h3 className="font-medium text-gray-900 text-xl">Default Product Commission</h3>
      ...
      <div className="">
        <div className='flex justify-between mb-4'>
          <h3 className="text-lg font-medium text-gray-900">Default Doctor Commission</h3>
          <label className="relative inline-flex items-center cursor-pointer">
            <input
              type="checkbox"
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-8">
            <div className="flex gap-6 items-cente">
              <h3 className="text-lg font-medium text-gray-900">Special Commission</h3>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-gray-200 items-center justify-center">
                  ...
                  <th className="text-left py-3 px-4 font-semibold">Doctor's Commission</th>
                  <th className="text-left py-3 px-4 font-semibold">Product Name</th>
                  <th className="text-left py-3 px-4 font-semibold">Product's Commission</th>
                  <th className="text-left py-3 px-4 font-semibold">Action</th>
                </tr>
              </thead>
              <tbody>
                {affiliateCommissionSpecialCommission.map((commission) => (
                  <tr key={commission.id} className="border-b border-gray-300">
                    <td className="py-4 px-4">
                      <div className="flex items-center rounded-full">
                        <div className="w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center mr-3">
                            <img src={commission.icon} className="rounded-full" />
                        </div>
                        <span className="text-sm text-gray-900">{commission.doctorName}</span>
                      </div>
                    </td>
                    <td className="pl-16 py-4 px-4 text-sm text-gray-900">{commission.doctorCommission}</td>
                    <td className="py-4 px-4 text-sm text-gray-900">{commission.productName}</td>
                    <td className="pl-16   py-4 px-4 text-sm text-gray-900">{commission.productCommission}</td>
